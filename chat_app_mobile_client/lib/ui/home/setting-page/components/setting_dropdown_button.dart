...
import 'package:chat_app_mobile_client/provider/language/language_profile.dart';
        ...
        return DropdownMenuItem<String>(
          ...
          child: Row(
            children: [
              SvgPicture.asset(
                value == "English"
                    ? Assets.assetsIconsUkFlat
                    : Assets.assetsIconsVnFlat,
                width: 17,
              ),
              const SizedBox(
                width: 8,
...
class _SettingThemeDropdownButtonState
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<ThemeProvider>(builder: (context, themeModel, child) {
      ...
      return DropdownButton(
        ...
        items: [kStringLightTheme, kStringDarkTheme]
            .map<DropdownMenuItem<String>>((String value) {
